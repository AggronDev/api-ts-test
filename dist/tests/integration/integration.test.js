...
describe('Testes de Integração', function () {
    ...
    var userDefault = {
        id: 1,
        name: 'Vinicius',
        email: 'ViniciusMoreira@email.com',
        password: '123'
    };
    ...
    describe('GET /api/users/all', function () {
        it('Deve retornar um Array com todos os Usuários', function (done) {
            helpers_1.request(helpers_1.app)
                ...
                helpers_1.expect(res.body.payload[1].name).to.be.equal(userDefault.name);
                helpers_1.expect(res.body.payload[1].email).to.be.equal(userDefault.email);
                done(error);
            });
        });
    });
    ...
    describe('DELETE /api/users/:id/destroy', function () {
        it('Deve deletar um', function (done) {
            helpers_1.request(helpers_1.app)
